...
const TRUSTED_GITHUB_CREDENTIALS_PATH: &str = ".dappercode/github-credentials";
...
mod tests {
    ...
    impl TestDir {
        fn new() -> Self {
            let path = std::env::temp_dir().join(format!("dappercode-terminal-{}", Uuid::new_v4()));
    ...
    fn credential_helper_requires_a_file_and_escapes_its_path() {
        ...
        let credentials = quoted_home.join(".dappercode/github-credentials");
