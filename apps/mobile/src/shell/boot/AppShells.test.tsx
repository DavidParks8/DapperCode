...
jest.mock('../../features/onboarding/screen/OnboardingScreen', () => ({
  OnboardingScreen: (props: Record<string, unknown>) => {
    mockOnboardingProps = props;
    return null;
  },
}));
jest.mock('@shell/state/bridge/actions', () => {
...
import { createBridgeTestStore, createTestStore, withAppStore } from '@shell/state/testing';
