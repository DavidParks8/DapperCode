...
import { activityAtom, bridgeRecoveryBannerVisibleAtom, heldActivityAtom } from '../state/composer';
import { useAtomValue, useSetAtom } from 'jotai';
import { useCallback, useEffect } from 'react';
import type { BridgeUiAction, BridgeUiSurface, ChatSummary } from '@bridge/types/types';
import {
...
} from '../approvals/userInputResolution';
