...
import { SubAgentDetailView } from '../agents/SubAgentDetailView';
import { GitCheckoutScreen } from '../../workspace/checkout/Screen';
...
import { toggleWorkspaceFavoriteAtom } from '../../workspace/state/workspaceActions';
...
jest.mock('../approvals/ApprovalBanner', () => ({
...
jest.mock('./LoadingGlyph', () => ({ LoadingGlyph: () => null }));
...
jest.mock('../approvals/BridgeUiSurface', () => ({
