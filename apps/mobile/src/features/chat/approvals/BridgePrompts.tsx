...
import { BridgeUiModal } from './BridgeUiSurface';
  ...
  return (
    <>
      <AppSheet
        ...
        onClose={() => {
          // This prompt requires a reply; it stays until one of the actions resolves it.
        }}
        dismissible={false}
        accessibilityLabel="Clarification needed"
      >
