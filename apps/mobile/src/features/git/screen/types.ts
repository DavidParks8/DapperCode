import type { GitBranchSummary, GitHistoryCommit } from '@bridge/types/types';
import type { UnifiedDiffDocument } from '../diff/unified';
import type { ChangedFileEntry } from './utils';
