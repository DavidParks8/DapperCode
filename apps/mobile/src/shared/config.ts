import { isInsecureRemoteUrl, normalizeBridgeUrlInput } from '@shell/state/bridgeUrl';
...
const allowInsecureRemoteBridge =
  process.env.EXPO_PUBLIC_ALLOW_INSECURE_REMOTE_BRIDGE?.trim().toLowerCase() === 'true';
