...
import type { Chat, ChatMessage, ChatStatus } from '@bridge/types/types';
import { type AgUiEventEnvelope, updateAgUiLiveAssistantMessages } from '@bridge/agui/agUi';
import type { AgUiMessageState, AgUiThreadMessageState } from '@bridge/agui/agUiMessagesState';
import { projectTranscript } from '../../features/chat/transcript/controllers/projectionController';
import {
  buildTranscriptDisplayItems,
  type TranscriptDisplayItem,
} from '../../features/chat/transcript/messages';
import { getMessageText, getSubAgentMeta } from '@bridge/messages';
