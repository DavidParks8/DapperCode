...
import type { MainScreenComposerRendererContext } from './mainScreenComposerRenderer';
...
describe('mainScreenComposerRenderer suggestion surfaces', () => {
  it('renders slash suggestions with reduce-motion aware entering/exiting animations', () => {
    const enteringSpy = jest.spyOn(
      jest.requireActual('../../testing/reanimatedMock').FadeIn,
      'reduceMotion',
    );
    const exitingSpy = jest.spyOn(
      jest.requireActual('../../testing/reanimatedMock').FadeOut,
      'reduceMotion',
    );
