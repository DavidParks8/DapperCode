import type { CollaborationMode, ModelOption, ReasoningEffort, ServiceTier } from '../../api/types';
import { formatModelOptionLabel } from '../../modelOptions';
import type { MainScreenModelCatalogStateContext } from './mainScreenModelCatalogState';
import {
  normalizeModelId,
