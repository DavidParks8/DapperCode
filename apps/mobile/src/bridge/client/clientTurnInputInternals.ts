...
import { normalizeEffort, normalizeModel } from '@bridge/client/clientBridgeResponseNormalization';
import type {
  AgentId,
  Chat,
  CollaborationMode,
...
import { type RawThread, readString, toRecord } from '@bridge/mapping/chatMapping';
