import { HostBridgeWsClientSocketTransportLayer } from '@bridge/ws/socketTransportLayer';
import { HostBridgeWsClientCore } from '@bridge/ws/core';
import { BridgeProtocolVersionError, isRpcRequestError } from '@bridge/ws/errors';
import { readIntegerLike, readString, toRecord } from '@shared/runtimeValidation';
import { readEventId, toAgUiTurnCompletionSnapshot } from '@bridge/ws/eventParsingInternals';
import type {
  BridgeSnapshotRequiredParams,
  BridgeSnapshotRequiredReason,
  RpcNotification,
} from '@bridge/types/types';
import type { ReplayEventsResponse } from '@bridge/ws/types';
